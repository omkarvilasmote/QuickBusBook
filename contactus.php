...
<body>
    ...
    <div class="canwereview">
        <form action="ContactUsact.php" method='post'>
            <h1><span><i class="ri-contacts-line"></i></span>contactUS</h1>
            <br><br>
            ...
            <textarea id="message" name="message" rows="10" cols="48" required placeholder="Min 100 letters" minlength='100'></textarea><br>
            <br>
